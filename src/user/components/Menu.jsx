...
const Menu = () => {
  ...
  return (
    <nav className="fixed w-full bg-white shadow-md border-b border-pink-100/50 mt-20 z-9999">
          ...
          <div className="flex space-x-8">
            {menuItems.map((item, index) => (
              ...
              >
                ...
                {showPopup && ((hoverGender === 'Nam' && item.label === 'NAM') || (hoverGender === 'Nu' && item.label === 'NỮ')) && categories.length > 0 && (
